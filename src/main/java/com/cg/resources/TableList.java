...
public class TableList {
	...
	public TableList sortBy(final int column) {
		return this.compareWith(new Comparator<String[]>() {
	...
	public void print() {
		...
		if (filter != null) {
			...
			localTable.removeIf(new Predicate<String[]>() {
				public boolean test(String[] arr) {
					String s = arr[findex];
		...
		localTable.forEach(new Consumer<String[]>() {
